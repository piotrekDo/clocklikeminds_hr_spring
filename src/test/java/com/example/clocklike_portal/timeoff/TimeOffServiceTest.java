...
class TimeOffServiceTest {
    ...
    void requestPtoShouldSetDaysTakenAndDaysLeftValuesOnAcceptorEntityAndAddPtoRequestToAcceptorAndApplier() {
        ...
        PtoEntity ptoEntity = new PtoEntity(1L,  "", false, null, null, null, LocalDateTime.now(), LocalDate.of(2024, 2, 12), LocalDate.of(2024, 2, 16), applier, acceptor, false, null, 5, 2, null, false, false, null);
        TimeOffDto timeOffDto = new TimeOffDto(1L, "", false, null, null, null, true, false, LocalDateTime.now(), LocalDate.of(2024, 2, 12), LocalDate.of(2024, 2, 16), 2L, "applier", "applier", "applier@test.com", false, 17, 5, null, 1L, "acceptor", "acceptor", "acceptor@mail.com", null, 5, 5, 2, null, null, null, null, null, null, null, false, false, null);
